...
func (o *RestColServiceGetCollection2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewRestColServiceGetCollection2OK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewRestColServiceGetCollection2Default(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewRestColServiceGetCollection2OK() *RestColServiceGetCollection2OK {
	return &RestColServiceGetCollection2OK{}
}
...
func (o *RestColServiceGetCollection2OK) Code() int {
	return 200
}
...
func (o *RestColServiceGetCollection2OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewRestColServiceGetCollection2Default(code int) *RestColServiceGetCollection2Default {
	return &RestColServiceGetCollection2Default{
		_statusCode: code,
	}
}
...
func (o *RestColServiceGetCollection2Default) IsSuccess() bool {
...
func (o *RestColServiceGetCollection2Default) IsCode(code int) bool {
	return o._statusCode == code
}

// Code gets the status code for the rest col service get collection2 default response
func (o *RestColServiceGetCollection2Default) Code() int {
...
func (o *RestColServiceGetCollection2Default) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
