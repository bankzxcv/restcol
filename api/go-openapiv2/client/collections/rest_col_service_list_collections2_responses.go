...
func (o *RestColServiceListCollections2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewRestColServiceListCollections2OK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewRestColServiceListCollections2Default(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewRestColServiceListCollections2OK() *RestColServiceListCollections2OK {
	return &RestColServiceListCollections2OK{}
}
...
func (o *RestColServiceListCollections2OK) Code() int {
	return 200
}

func (o *RestColServiceListCollections2OK) Error() string {
	return fmt.Sprintf("[GET /v1/projects/{projectId}/collections][%d] restColServiceListCollections2OK  %+v", 200, o.Payload)
}

func (o *RestColServiceListCollections2OK) String() string {
	return fmt.Sprintf("[GET /v1/projects/{projectId}/collections][%d] restColServiceListCollections2OK  %+v", 200, o.Payload)
}

func (o *RestColServiceListCollections2OK) GetPayload() models.APIListCollectionsResponse {
	return o.Payload
}

func (o *RestColServiceListCollections2OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewRestColServiceListCollections2Default(code int) *RestColServiceListCollections2Default {
	return &RestColServiceListCollections2Default{
		_statusCode: code,
	}
}
...
func (o *RestColServiceListCollections2Default) IsSuccess() bool {
	return o._statusCode/100 == 2
}

// IsRedirect returns true when this rest col service list collections2 default response has a 3xx status code
func (o *RestColServiceListCollections2Default) IsRedirect() bool {
...
func (o *RestColServiceListCollections2Default) IsCode(code int) bool {
	return o._statusCode == code
}

// Code gets the status code for the rest col service list collections2 default response
func (o *RestColServiceListCollections2Default) Code() int {
	return o._statusCode
}

func (o *RestColServiceListCollections2Default) Error() string {
	return fmt.Sprintf("[GET /v1/projects/{projectId}/collections][%d] RestColService_ListCollections2 default  %+v", o._statusCode, o.Payload)
}

func (o *RestColServiceListCollections2Default) String() string {
	return fmt.Sprintf("[GET /v1/projects/{projectId}/collections][%d] RestColService_ListCollections2 default  %+v", o._statusCode, o.Payload)
}

func (o *RestColServiceListCollections2Default) GetPayload() *models.RPCStatus {
	return o.Payload
}

func (o *RestColServiceListCollections2Default) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
