...
func (o *RestColServiceQueryDocumentsStream3Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewRestColServiceQueryDocumentsStream3OK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewRestColServiceQueryDocumentsStream3Default(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewRestColServiceQueryDocumentsStream3OK() *RestColServiceQueryDocumentsStream3OK {
	return &RestColServiceQueryDocumentsStream3OK{}
}
...
func (o *RestColServiceQueryDocumentsStream3OK) Error() string {
	return fmt.Sprintf("[GET /v1/projects/{projectId}/collections/{collectionId}:docstream][%d] restColServiceQueryDocumentsStream3OK  %+v", 200, o.Payload)
}
...
func (o *RestColServiceQueryDocumentsStream3OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(RestColServiceQueryDocumentsStream3OKBody)
...
func NewRestColServiceQueryDocumentsStream3Default(code int) *RestColServiceQueryDocumentsStream3Default {
	return &RestColServiceQueryDocumentsStream3Default{
		_statusCode: code,
	}
}
...
func (o *RestColServiceQueryDocumentsStream3Default) Error() string {
	return fmt.Sprintf("[GET /v1/projects/{projectId}/collections/{collectionId}:docstream][%d] RestColService_QueryDocumentsStream3 default  %+v", o._statusCode, o.Payload)
}
...
func (o *RestColServiceQueryDocumentsStream3Default) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
/*
RestColServiceQueryDocumentsStream3OKBody Stream result of apiGetDocumentResponse
swagger:model RestColServiceQueryDocumentsStream3OKBody
*/
...
func (o *RestColServiceQueryDocumentsStream3OKBody) validateError(formats strfmt.Registry) error {
	...
	if o.Error != nil {
		if err := o.Error.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("restColServiceQueryDocumentsStream3OK" + "." + "error")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("restColServiceQueryDocumentsStream3OK" + "." + "error")
			}
			return err
		}
	}
...
func (o *RestColServiceQueryDocumentsStream3OKBody) validateResult(formats strfmt.Registry) error {
	...
	if o.Result != nil {
		if err := o.Result.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("restColServiceQueryDocumentsStream3OK" + "." + "result")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("restColServiceQueryDocumentsStream3OK" + "." + "result")
			}
			return err
		}
	}
...
func (o *RestColServiceQueryDocumentsStream3OKBody) contextValidateError(ctx context.Context, formats strfmt.Registry) error {
...
func (o *RestColServiceQueryDocumentsStream3OKBody) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (o *RestColServiceQueryDocumentsStream3OKBody) UnmarshalBinary(b []byte) error {
	var res RestColServiceQueryDocumentsStream3OKBody
