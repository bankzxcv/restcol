...
func (o *RestColServiceGetDocument2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewRestColServiceGetDocument2OK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewRestColServiceGetDocument2Default(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewRestColServiceGetDocument2OK() *RestColServiceGetDocument2OK {
	return &RestColServiceGetDocument2OK{}
}
...
func NewRestColServiceGetDocument2Default(code int) *RestColServiceGetDocument2Default {
	return &RestColServiceGetDocument2Default{
		_statusCode: code,
	}
}
...
func (o *RestColServiceGetDocument2Default) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
