...
func (o *RestColServiceCreateDocument2OK) Error() string {
	return fmt.Sprintf("[POST /v1/projects/{pid}/collections/{cid}:add][%d] restColServiceCreateDocument2OK  %+v", 200, o.Payload)
}
...
func (o *RestColServiceCreateDocument2Default) Error() string {
	return fmt.Sprintf("[POST /v1/projects/{pid}/collections/{cid}:add][%d] RestColService_CreateDocument2 default  %+v", o._statusCode, o.Payload)
}
