...
func (o *RestColServiceCreateDocumentOK) Error() string {
	return fmt.Sprintf("[POST /v1/projects/{projectId}/newdoc][%d] restColServiceCreateDocumentOK  %+v", 200, o.Payload)
}
...
func (o *RestColServiceCreateDocumentDefault) Error() string {
	return fmt.Sprintf("[POST /v1/projects/{projectId}/newdoc][%d] RestColService_CreateDocument default  %+v", o._statusCode, o.Payload)
}
