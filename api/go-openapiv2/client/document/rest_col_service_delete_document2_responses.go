...
func (o *RestColServiceDeleteDocument2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewRestColServiceDeleteDocument2OK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewRestColServiceDeleteDocument2Default(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewRestColServiceDeleteDocument2OK() *RestColServiceDeleteDocument2OK {
	return &RestColServiceDeleteDocument2OK{}
}
...
func (o *RestColServiceDeleteDocument2OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewRestColServiceDeleteDocument2Default(code int) *RestColServiceDeleteDocument2Default {
	return &RestColServiceDeleteDocument2Default{
		_statusCode: code,
	}
}
...
func (o *RestColServiceDeleteDocument2Default) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
