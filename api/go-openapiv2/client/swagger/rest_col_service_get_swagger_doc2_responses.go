...
func (o *RestColServiceGetSwaggerDoc2OK) Error() string {
	return fmt.Sprintf("[GET /v1/projects/{projectId}/apidoc][%d] restColServiceGetSwaggerDoc2OK  %+v", 200, o.Payload)
}
...
func (o *RestColServiceGetSwaggerDoc2Default) Error() string {
	return fmt.Sprintf("[GET /v1/projects/{projectId}/apidoc][%d] RestColService_GetSwaggerDoc2 default  %+v", o._statusCode, o.Payload)
}
