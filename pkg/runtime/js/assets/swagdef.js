function doconvert(input) {
  // ref: https://github.com/Roger13/SwagDefGen
  function convert() {
    "use strict";
    // ---- Global variables ----
  ...
  function mockDucument(inJSON) {
    var fieldsAndValue = {
      "JSON": {
        value: inJSON,
      },
      "noInt": {
        checked: true, // use number instead of int
      },
      "requestExamples": {
        checked: true // add value as example
      },
      "nullType": {
        value: "string" // use string for default typing
      },
      "yamlOut": {
        checked: false, // no yaml output
      },
      // output field
      "Swagger": {
        value: ""
